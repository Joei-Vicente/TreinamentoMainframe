      ...
      *----------------------------------------------------------------*00024101
                                                                        00024201
      *   77 WRK-AUX-SALARIO          PIC S9(08)V99 VALUE ZEROS.
                                                                        00024201
      *================================================================*00024301
      ...
      *----------------------------------------------------------------*00028201
           ...
           EXEC SQL
            SELECT ID,NOME,SETOR,SALARIO,DATAADM,EMAIL                  00028301
             INTO :DB2-ID,
                  :DB2-NOME,                                            00028301
                  :DB2-SETOR,
                  :DB2-SALARIO,                                         00028301
                  :DB2-DATAADM,
                  :DB2-EMAIL     :WRK-INDICATOR                         00028301
               FROM FOUR001.FUNC
           ...
           MOVE WRK-NOME-AC            TO DB2-NOME                      00027201
             ...
             WHEN DB2-EMAIL            NOT EQUAL
                  ...
                  MOVE WRK-EMAIL-AC    TO DB2-DATAADM                   00027201
                                                                        00028301
           END-EVALUATE.                                                00028301

           EXEC SQL                                                     00028601
             UPDATE FOUR001.FUNC                                        00028701
