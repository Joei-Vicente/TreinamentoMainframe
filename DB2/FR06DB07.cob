      ...
      *================================================================*00003001
                                                                        00004001
       PROGRAM-ID. FR06DB07.                                            00005001
                                                                        00006001
      *================================================================*00007001
      *   AUTOR...........: JOEI LORENTI                               *00008001
      *   ANALISTA........: IVAN SANCHES                               *00008101
      *   DATA ...........: 07/06/2022                                 *00009001
      *----------------------------------------------------------------*00009101
      *   OBJETIVO........: LER  OS REGISTROS DA TABELA DB2 (FUNC2)    *00010001
      *                     MOSTRAR TODOS OS REGISTROS                 *00010101
      *                     MOSTRAR TOTAL DE REGISTROS LIDOS           *00010101
      *                     MOSTRAR SOMA DE SALARIOS                   *00010101
      *                     MOSTRAR MEDIA DE SALARIOS                  *00010101
      *                                                                *00010201
      *----------------------------------------------------------------*00009101
      *   INCLUDES........:                                            *00010201
      *    DDNAME                                                      *00010201
      *   #BKFUNC2 - BOOK DA TABELA FUNC2                              *00010201
      *   #GRVLOG - BOOK DO ARQUIVO DE GRAVACAO DE ERROS               *00010201
      *                                                                *00010201
      *                                                                *00010201
      *================================================================*00011001
                                                                        00012001
      ...
      *----------------------------------------------------------------*00024101
           ...
           EXEC SQL                                                     00024201
            DECLARE CFUNC CURSOR FOR                                    00024201
             SELECT * FROM FOUR001.FUNC2                                00024201
              ORDER BY NOME                                             00024201
           END-EXEC.                                                    00024201
                                                                        00024201
      *----------------------------------------------------------------*00023801
       01 FILLER                      PIC  X(050)         VALUE         00023901
      ...
      *----------------------------------------------------------------*00027001
            ...
            IF (SQLCODE             NOT EQUAL ZEROS AND +100) OR        00027301
               (SQLWARN0             EQUAL 'W')                         00027301
               MOVE SQLCODE          TO WRK-SQLCODE                     00027301
               DISPLAY 'ERRO ... '   WRK-SQLCODE                        00027301
            END-IF.                                                     00027301

            IF (SQLCODE              EQUAL  +100)                       00027301
               DISPLAY WRK-ID '...SEM FUNCIONARIOS'                     00027301
            END-IF.                                                     00027301
                                                                        00027301
                                                                        00027301
      *----------------------------------------------------------------*00027601
      ...
      *----------------------------------------------------------------*00028201
              ...
              DISPLAY 'DATAADM ' DB2-DATAADM                            00032501
               ...
               IF WRK-EMAIL-NULL = 0                                    00032601
                 DISPLAY 'EMAIL.. ' DB2-EMAIL                           00032701
              DISPLAY '-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-' 00032101
               ELSE                                                     00032801
                DISPLAY '-- SEM EMAIL '                                 00032901
              DISPLAY '-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-' 00032101
               END-IF.                                                  00033001
                                                                        00030001
               IF WRK-TEL-NULL = 0                                      00032601
                 DISPLAY 'EMAIL.. ' DB2-TELEFONE                        00032701
              DISPLAY '-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-' 00032101
               ELSE                                                     00032801
                DISPLAY '-- SEM TELEFONE '                              00032901
              DISPLAY '-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-' 00032101
               END-IF.                                                  00033001
               PERFORM 4000-LER-FUNCIONARIO.                            00030001
                                                                        00030001
      *----------------------------------------------------------------*00030101
      ...
      *----------------------------------------------------------------*00030301
                                                                        00030401
      *----------------------------------------------------------------*00028001
       2100-MEDIA-SALARIO               SECTION.                        00028101
      *----------------------------------------------------------------*00028201
                                                                        00028301
             COMPUTE WRK-MEDIA-SAL = WRK-SOMA-SAL / WRK-ACUM-LIDOS.     00032101
                                                                        00030001
      *----------------------------------------------------------------*00030101
       2100-99-FIM.                    EXIT.                            00030201
      *----------------------------------------------------------------*00030301
                                                                        00034901
      *----------------------------------------------------------------*00035001
      ...
      *----------------------------------------------------------------*00035201
            ...
            DISPLAY ' * SOMA DOS SALARIOS.:' WRK-SOMA-SAL
            DISPLAY ' * MEDIA DOS SALARIOS.:' WRK-MEDIA-SAL
            DISPLAY ' *                                               *'
            DISPLAY ' -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*'.
      ...
      *----------------------------------------------------------------*00037201
                                                                        00037301
      *----------------------------------------------------------------*00035001
       4000-LER-FUNCIONARIO            SECTION.                         00035101
      *----------------------------------------------------------------*00035201
                                                                        00036001
           EXEC SQL                                                     00028601
             FETCH CFUNC                                                00028701
              INTO :DB2-ID,                                             00028801
                   ...
                   :DB2-TELEFONE  :WRK-TEL-NULL                         00029301
           END-EXEC.                                                    00029601
           ...
           EVALUATE SQLCODE                                             00031001
            ...
            WHEN 0                                                      00032001
              ...
              ADD DB2-SALARIO           TO WRK-SOMA-SAL
              CONTINUE
