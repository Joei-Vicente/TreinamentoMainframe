      ...
      *----------------------------------------------------------------*00024101
           ...
           EXEC SQL                                                     00024201
            DECLARE CFUNC CURSOR FOR                                    00024201
             SELECT * FROM FOUR001.FUNC                                 00024201
      ...
      *----------------------------------------------------------------*00027001
            ...
            END-EXEC.                                                   00027301
                                                                        00027301
             EVALUATE SQLCODE                                           00027301
                                                                        00027301
              WHEN 0                                                    00027301
                PERFORM 4000-LER-FUNCIONARIO                            00027301
                                                                        00027301
              WHEN 100                                                  00027301
                DISPLAY 'SEM FUNCIONARIOS'                              00027301

              WHEN OTHER                                                00027301
                MOVE SQLCODE TO WRK-SQLCODE                             00027301
                DISPLAY ' ERRO ' WRK-SQLCODE ' NO OPEN CURSOR'          00027301
      *         MOVE 200 TO RETURN-CODE                                 00027301
      ...
      *----------------------------------------------------------------*00035201
           ...
           EXEC SQL                                                     00028601
             FETCH CFUNC                                                00028701
              INTO :DB2-ID,                                             00028801
                   ...
                   :DB2-EMAIL     :WRK-INDICATOR                        00029301
           END-EXEC.                                                    00029601
           ...
           EVALUATE SQLCODE                                             00031001
            ...
            WHEN OTHER                                                  00033401
              ...
              MOVE '4000 '             TO WRK-MSG-ERRO                  00033701
