      ...
      *----------------------------------------------------------------*00009101
      *   OBJETIVO........: INSERE DADOS NA TABELA (FUNC2)A PARTIR DA  *00010001
      *                     SYSIN                                      *00010101
      *                                                                *00010201
      *----------------------------------------------------------------*00009101
      *   ARQUIVOS........:                                            *
      ...
      *----------------------------------------------------------------*00021001
                                                                        00021101
       77 WRK-MAIL-NULL                PIC S9(4) COMP VALUE ZEROS.      00021201
      ...
      *----------------------------------------------------------------*00023801
       01 FILLER                       PIC  X(050)         VALUE        00023901
           '*** VARIAVEIS AUXILIARES ***'.                              00024001
      *----------------------------------------------------------------*00024101
                                                                        00024201
       77 WRK-EMAIL-LEN                PIC S9(4).                       00024201
                                                                        00024201
       77 WRK-POSICAO                  PIC S9(4).                       00024201
                                                                        00024201
                                                                        00024201
                                                                        00024201
      ...
      *    COMPUTE WRK-TAM =FUNCTION LENGTH(WRK-EMAIL-AC)
           ...
           MOVE WRK-EMAIL-AC           TO DB2-EMAIL-TEXT.               00027201
           MOVE WRK-TEL-AC             TO DB2-TELEFONE.                 00027201
                                                                        00027301
                                                                        00028501
           EXEC SQL                                                     00028601
             INSERT INTO                                                00028701
             FOUR001.FUNC2(ID,NOME,SETOR,SALARIO,DATAADM,EMAIL,TELEFONE)00028701
