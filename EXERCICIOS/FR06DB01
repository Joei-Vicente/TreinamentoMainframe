      ...
      *================================================================*00003001
                                                                        00004001
       PROGRAM-ID. FR06DB01.                                            00005001
                                                                        00006001
      *================================================================*00007001
      *   AUTOR...........: JOEI LORENTI                               *00008001
      *   ANALISTA........: IVAN SANCHES                               *00008101
      *   DATA ...........: 01/06/2022                                 *00009001
      *----------------------------------------------------------------*00009101
      *   OBJETIVO........: LER TABELA DB2 (FUNC)                      *00010001
      *                                                                *00010101
      *                                                                *00010201
      *================================================================*00011001
                                                                        00012001
      ...
      *----------------------------------------------------------------*00028201
           ...
           MOVE WRK-ID                 TO DB2-ID.                       00028401
                                                                        00028501
           EXEC SQL                                                     00028601
             SELECT ID,NOME,SETOR,SALARIO,DATAADM,EMAIL                 00028701
      ...
      *----------------------------------------------------------------*00035201
                                                                        00036001
            MOVE 'FR06DB01' TO WRK-PROGRAMA.                            00036801
                                                                        00036901
      *----------------------------------------------------------------*00037001
